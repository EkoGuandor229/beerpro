...
public class CreateRatingViewModel extends ViewModel {
    ...
    public Task<Rating> saveRating(Beer item, float rating, String comment, Uri localPhotoUri, String placeName, String placeCoords,
                                   int bitterness, int headacheFactor, String aroma) {
        ...
        return uploadFileToFirebaseStorage(localPhotoUri).continueWithTask(task -> {
            ...
            Rating newRating = new Rating(null, item.getId(), item.getName(), user.getUid(), user.getDisplayName(),
                    ...
                    placeCoords, placeName, bitterness, headacheFactor, aroma);
